    ...
    {loginLoading ? <SpinnerWindow /> : (
          ...
          <div className='max-w-[400px] w-full px-4 py-8 bg-secondary'>
              ...
              <Formik
                          ...
                          <Form className="mt-5">
                            ...
                            <div className="input-wrap">
                              ...
                              {props.values.password && (
                                <span
                                  className="absolute text-base translate-y-1/2 cursor-pointer bottom-1/2 right-2 top-1/2"
                  ...
                  <button className='btn btn--accent w-full p-4 justify-center'>{mutation.isPending ? <SpinnerButton/> : "Sign In"}</button>
                  </Form>
                    );
                  }}
                </Formik>
