...
import ModalAddHonor from './ModalAddHonor'
...
const Honor = () => {
    ...
    const {
        ...
        isSearch ? "/v1/honor/search" : "/v1/honor", // endpoint
  ...
  return (
    <section className='flex overflow-x-hidden'>
        ...
        <ul className='nav'>
            ...
            <li className='nav-link active'><Link to="/honor"><FaCertificate/>Honor Certifications</Link></li>
        ...
        <main className='w-[calc(100%-250px)]'>
            ...
            <div className='flex'>
                ...
                <HonorTable isLoading={isLoading} honor={honor} isFetching={isFetching} setItemEdit={setItemEdit}/>
            </div>
        </div>  
    </main>


    {store.isAdd && <ModalAddHonor itemEdit={itemEdit}/>}
