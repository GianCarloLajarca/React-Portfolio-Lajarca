...
const ModalAddHonor = ({itemEdit}) => {
    ...
    const initVal = {
        ...
        honor_photo: itemEdit ? itemEdit.honor_photo : "",
    ...
    const yupSchema = Yup.object({
        ...
        // honor_photo: Yup.string().required('Required'),
                  ...
                  <Formik
                      ...
                      onSubmit={async (values) => {
                        ...
                        mutation.mutate({...values, 
                            honor_photo:
                            (itemEdit && itemEdit.honor_photo === "") || photo
                              ? photo === null
                                ? itemEdit.honor_photo
                                : photo.name
                              : values.honor_photo,})
                      }}
                  >
                      ...
                      <div className="input-wrap">
                            ...
                            {photo || (itemEdit && itemEdit.honor_photo !== "") ? (
                            <img
                            src={
                            photo
                            ? URL.createObjectURL(photo) // preview
                            : itemEdit.honor_photo // check db
                            ? devBaseImgUrl + "/" + itemEdit.honor_photo
                            : null
                            }
                            alt="Photo"
