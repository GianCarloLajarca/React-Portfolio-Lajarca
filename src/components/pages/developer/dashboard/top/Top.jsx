...
import ModalAddTop from './ModalAddTop'
...
const Top = () => {
    ...
    const {
        ...
        isSearch ? "/v1/top/search" : "/v1/top", // endpoint
    ...
    <section className='flex overflow-x-hidden'>
       <aside className='px-4 py-6 w-[250px] text-primary h-screen border-r border-line'>
        ...
        <ul className='nav'>
            ...
            <li className='nav-link active'><Link to="/top"><FaCertificate/>Top Student Certifications</Link></li>
        ...
        <main className='w-[calc(100%-250px)]'>
            ...
            <div className='flex'>
                ...
                <div className='flex justify-between items-center'>
                    <h1>Top Performing Student Database</h1>
                ...
                <TopTable isLoading={isLoading} top={top} isFetching={isFetching} setItemEdit={setItemEdit}/>
            </div>
        </div>  
    </main>


    {store.isAdd && <ModalAddTop itemEdit={itemEdit}/>}
