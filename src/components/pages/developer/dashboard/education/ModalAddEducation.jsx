...
const ModalAddEducation = ({itemEdit}) => {
    ...
    const initVal = {
        ...
        education_photo: itemEdit ? itemEdit.education_photo : "",
    ...
    const yupSchema = Yup.object({
        ...
        // education_photo: Yup.string().required('Required'),
                  ...
                  <Formik
                      ...
                      onSubmit={async (values) => {
                        ...
                        mutation.mutate({...values, 
                            education_photo:
                            (itemEdit && itemEdit.education_photo === "") || photo
                              ? photo === null
                                ? itemEdit.education_photo
                                : photo.name
                              : values.education_photo,})
                      }}
                  >
                      {(props) => {
                          return (
                      ...
                      <div className="input-wrap">
                            ...
                            {photo || (itemEdit && itemEdit.education_photo !== "") ? (
                        <img
                          src={
                            photo
                              ? URL.createObjectURL(photo) // preview
                              : itemEdit.education_photo // check db
                              ? devBaseImgUrl + "/" + itemEdit.education_photo
                              : null
                          }
                          alt="Photo"
                      ...
                      {(photo !== null ||
                        (itemEdit && itemEdit.education_photo !== "")) && (
